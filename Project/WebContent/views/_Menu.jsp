...
<body>
	<nav id="menu">
		<ul>
			...
			<li style="${styleDepartment}"><a href="DepartmentList">Quản lý phòng ban</a></li>
			<li style='${styleEmployee}'><a href="EmployeeList">Quản lý nhân viên</a></li>
			<li style='${styleSalary}'><a href="SalaryList">Quản lý lương</a></li>
